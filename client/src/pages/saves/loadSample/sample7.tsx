...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question7_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION7',
      question7_title: selectedSample?.sample_title || '',
      question7_answer1: selectedSample?.sample_answer1 || '',
      question7_answer2: selectedSample?.sample_answer2 || '',
      question7_answer3: selectedSample?.sample_answer3 || '',
      question7_answer4: selectedSample?.sample_answer4 || '',
      question7_answer_no: selectedSample?.sample_answer_no || '',
      question7_description: selectedSample?.sample_description || '',
