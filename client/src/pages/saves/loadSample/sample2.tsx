...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question2_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION2',
      question2_title: selectedSample?.sample_title || '',
      question2_answer1: selectedSample?.sample_answer1 || '',
      question2_answer2: selectedSample?.sample_answer2 || '',
      question2_answer3: selectedSample?.sample_answer3 || '',
      question2_answer4: selectedSample?.sample_answer4 || '',
      question2_answer_no: selectedSample?.sample_answer_no || '',
      question2_description: selectedSample?.sample_description || '',
