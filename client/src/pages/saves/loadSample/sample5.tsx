...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question5_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION5',
      question5_title: selectedSample?.sample_title || '',
      question5_answer1: selectedSample?.sample_answer1 || '',
      question5_answer2: selectedSample?.sample_answer2 || '',
      question5_answer3: selectedSample?.sample_answer3 || '',
      question5_answer4: selectedSample?.sample_answer4 || '',
      question5_answer_no: selectedSample?.sample_answer_no || '',
      question5_description: selectedSample?.sample_description || '',
