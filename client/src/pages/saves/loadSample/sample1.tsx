...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question1_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION1',
      question1_title: selectedSample?.sample_title || '',
      question1_answer1: selectedSample?.sample_answer1 || '',
      question1_answer2: selectedSample?.sample_answer2 || '',
      question1_answer3: selectedSample?.sample_answer3 || '',
      question1_answer4: selectedSample?.sample_answer4 || '',
      question1_answer_no: selectedSample?.sample_answer_no || '',
      question1_description: selectedSample?.sample_description || '',
