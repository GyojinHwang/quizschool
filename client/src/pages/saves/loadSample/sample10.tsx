...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question10_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION10',
      question10_title: selectedSample?.sample_title || '',
      question10_answer1: selectedSample?.sample_answer1 || '',
      question10_answer2: selectedSample?.sample_answer2 || '',
      question10_answer3: selectedSample?.sample_answer3 || '',
      question10_answer4: selectedSample?.sample_answer4 || '',
      question10_answer_no: selectedSample?.sample_answer_no || '',
      question10_description: selectedSample?.sample_description || '',
