...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener?.postMessage({
      type: 'SET_QUESTION9',
      question9_title: selectedSample?.sample_title || '',
      question9_answer1: selectedSample?.sample_answer1 || '',
      question9_answer2: selectedSample?.sample_answer2 || '',
      question9_answer3: selectedSample?.sample_answer3 || '',
      question9_answer4: selectedSample?.sample_answer4 || '',
      question9_answer_no: selectedSample?.sample_answer_no || '',
      question9_description: selectedSample?.sample_description || '',
