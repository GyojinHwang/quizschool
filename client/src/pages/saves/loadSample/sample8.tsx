...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question8_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION8',
      question8_title: selectedSample?.sample_title || '',
      question8_answer1: selectedSample?.sample_answer1 || '',
      question8_answer2: selectedSample?.sample_answer2 || '',
      question8_answer3: selectedSample?.sample_answer3 || '',
      question8_answer4: selectedSample?.sample_answer4 || '',
      question8_answer_no: selectedSample?.sample_answer_no || '',
      question8_description: selectedSample?.sample_description || '',
