...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question6_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION6',
      question6_title: selectedSample?.sample_title || '',
      question6_answer1: selectedSample?.sample_answer1 || '',
      question6_answer2: selectedSample?.sample_answer2 || '',
      question6_answer3: selectedSample?.sample_answer3 || '',
      question6_answer4: selectedSample?.sample_answer4 || '',
      question6_answer_no: selectedSample?.sample_answer_no || '',
      question6_description: selectedSample?.sample_description || '',
