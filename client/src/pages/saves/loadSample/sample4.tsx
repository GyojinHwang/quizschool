...
const SearchSampleQuestions: React.FC = () => {
  ...
  const handleConfirm = () => {
    ...
    window.opener.document.getElementById("question4_answer_no").value = selectedSample?.sample_answer_no;

    window.opener?.postMessage({
      type: 'SET_QUESTION4',
      question4_title: selectedSample?.sample_title || '',
      question4_answer1: selectedSample?.sample_answer1 || '',
      question4_answer2: selectedSample?.sample_answer2 || '',
      question4_answer3: selectedSample?.sample_answer3 || '',
      question4_answer4: selectedSample?.sample_answer4 || '',
      question4_answer_no: selectedSample?.sample_answer_no || '',
      question4_description: selectedSample?.sample_description || '',
