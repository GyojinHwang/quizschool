...
const PostCreate = () => {
    ...
    const questionnumber = topSubs?.map((sub) => {
        return sub.questionnumber;
    })
        ...
        <div className='flex flex-col justify-center pt-16'>
                    <div className='w-10/12 mx-auto md:w-96'>
                        <div className='p-4 bg-white rounded'>
                            <h1 className='mb-3 text-lg'>학생 만들기</h1>
                            ...
                            <div className='relative mb-2'>
                                ...
                                <select onChange={(e) => setAnswerno(e.target.value)}>
                                    <option value="not_selected">직업</option>
                                    <option value="1">마법사</option>
                                    <option value="2">전사</option>
                                    <option value="3">힐러</option>
