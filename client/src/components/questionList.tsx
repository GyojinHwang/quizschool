    ...
    return (
        ...
        >
            ...
            <div className="flex w-full p-2">
                ...
                <div>
                    <a className="my-1 font-bold">{sample_title} <br /> <a className="font-thin">
                        {sample_answer_no === "1"
                            ? <a>{sample_answer1}</a>
                            : (sample_answer_no === "2"
                                ? <a>{sample_answer2}</a> :
            ...
            <div className="w-full">
                <a className='ml-10 font-bold'>
                    <button className=' ml-6 w-16 py-2 mb-1 text-xs font-bold border border-gray-400 rounded'>취소</button>
                    <button className=' w-16 py-2 mb-1 text-xs font-bold border border-gray-400 rounded'>완료</button>
                    </a>
            </div>
        </div>
    )
